...
const DOWNLOADS = [
  ...
  { label: "Windows", href: `${RELEASES}/Surround-windows-x64.exe`, primary: false },
  { label: "Linux — AppImage", href: `${RELEASES}/Surround-linux-x86_64.AppImage`, primary: false },
  { label: "Linux — .deb", href: `${RELEASES}/Surround-linux-amd64.deb`, primary: false },
];
  ...
  return (
    <main className="relative overflow-hidden">
      ...
      <section className="mx-auto max-w-3xl px-6 py-20 text-center">
        ...
        <p className="mx-auto mt-3 max-w-md text-sm leading-relaxed text-muted-foreground">
          Once the host is running, phones join right from a browser on the same
          Wi-Fi — no install. Native iOS &amp; Android apps are on the way.
        </p>
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          <Button asChild size="lg" className="px-7 text-base">
            <a href="#download">Get the host app</a>
          </Button>
